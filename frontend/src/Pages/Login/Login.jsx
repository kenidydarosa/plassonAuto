...
// import NotificationListener from '../../services/Notification.jsx';
...
//       <NotificationListener userId={userDB} />
...
import NotificationListener from '../../services/Notification.js';
...
const Login = () => {
  ...
  const [errorData, setErrorData] = useState({ title: '', msg: '', icon: '' });
  const [showAlert, setShowAlert] = useState(false);
  const [showNotificationListener, setShowNotificationListener] = useState(false); // Controla o NotificationListener
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      // Habilita o NotificationListener após login bem-sucedido
      setShowNotificationListener(true);
  ...
  return (
    <View style={[styleJS.pageContainer, { justifyContent: 'center' }]}>
      {/* Renderiza o NotificationListener apenas se o login for bem-sucedido */}
      {showNotificationListener && <NotificationListener userId={userDB.id} />}
